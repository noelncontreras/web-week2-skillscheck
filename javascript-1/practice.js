...
//Code Here
function iLove(name, books) {
	return `${name} loves ${books}`;
}
...
// Code Here
var filtered = myNumbers.filter(i => {
	return i > 100;
})
...
// Code Here
function trueFriends(people){
	return people.friend !== true;
}
var enemies = people.filter(trueFriends);
...
// Code Here
var totallyAwesome = people => people.reduce((acc, awesomeLevel) => acc + awesomeLevel, 0);